...
def parse_predict_args() -> Namespace:
    temp_input = '--test_path data/bbbp.csv --preds_path bbbp_predict.csv --checkpoint_dir bbbp.csv'
...
def parse_train_args() -> Namespace:
    ...
    """
    temp_input = '--data_path data/bbbp.csv --dataset_type classification --save_dir log/bbbp --gpu 0 --num_folds 10 --features_generator morgan --no_features_scaling'
